...
const joaoHenrique = {
  ...
  location   : "Brazil 🇧🇷",
  passions   : ["Software Development", "UI/UX Design", "Problem Solving"],
  focus      : ["Clean Code", "Scalable Architectures", "Great User Experiences"],
  learning   : "Always exploring new tools, languages & frameworks 📚",
